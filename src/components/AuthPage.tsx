      ...
      <div className="w-[380px]">
        <div className="bg-white dark:bg-[#2C2C2E] rounded-2xl shadow-sm border border-gray-100 dark:border-[#38383A] p-10">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-[#F5F5F5]">Things</h1>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 text-sm font-medium text-white bg-gray-900 border border-gray-900 rounded-xl hover:bg-gray-800 transition-colors"
            >
