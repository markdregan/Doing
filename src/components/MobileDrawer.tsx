...
export default function MobileDrawer({ open, onClose, onSearchOpen, onSettingsOpen }: MobileDrawerProps) {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`absolute left-0 top-0 bottom-0 w-[260px] bg-white dark:bg-[#151516] border-r border-gray-100 dark:border-[#38383A] flex flex-col transition-transform duration-200 ${
